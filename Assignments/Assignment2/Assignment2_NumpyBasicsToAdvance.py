...
def function4():
    ...
    return arr[:, [0, 1, 2]] = arr[:, [1, 0, 2]] #wrtie your code here
    """
    Expected Output:
          array([[1, 0, 2],
                [4, 3, 5],
...
def function7():
    ...
    return z = np.zeros(x.shape, dtype=np.int64) #write your code here
...
def function8():
    ...
    x = x = np.full((2, 5), 6, dtype='uint32') #write your code here
...
def function11():
    ...
    ans = arr.copy()
          ans[1::2] = -1 #write your code here
...
def function15():
    ...
    ans = arr[:3, 1:2] = np.sort(arr[:3, 1:2], axis = 0)
